...
class AdminShowFlights extends React.Component {
  ...
  async componentDidMount() {
    fetch("https://agile-retreat-56464.herokuapp.comget_flights/all")
      .then((res) => res.json())
      .then((json) => {
  ...
  handleDeleteFlight = async (e) => {
    ...
    const response = await fetch(`https://agile-retreat-56464.herokuapp.com/api/admin/delete_flight/${targetFlightID}`, {
      method: "POST",
      headers: {
