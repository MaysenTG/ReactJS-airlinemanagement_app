...
class EditAccount extends React.Component {
  ...
  async componentDidMount() {
    ...
    const response = await fetch(`https://agile-retreat-56464.herokuapp.com/api/get_user_data/${idParam}`, {
      method: "POST",
      headers: {
  ...
  onSubmitEdit = async (e) => {
    ...
    const response = await fetch(`https://agile-retreat-56464.herokuapp.com/api/edit_user_data/${idParam}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
