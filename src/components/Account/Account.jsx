...
class Account extends React.Component {
  ...
  async componentDidMount() {
    ...
    const response = await fetch(`https://agile-retreat-56464.herokuapp.com/api/get_user_flight_data/${idParam}`, {
      method: "POST",
      headers: {
    ...
    const response_user_data = await fetch(`https://agile-retreat-56464.herokuapp.com/api/get_user_data/${idParam}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  cancelFlightBooking = async (e) => {
    ...
    const response = await fetch(`https://agile-retreat-56464.herokuapp.com/api/cancel_booking/${flight_id}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
