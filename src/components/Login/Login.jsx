...
export default class Login extends Component {
  ...
  handleSubmit = async (e) => {
    ...
    const response = await fetch("https://agile-retreat-56464.herokuapp.com/api/account/login", {
      method: "POST",
      headers: {
  ...
  handleCreateAccount = async (e) => {
    ...
    const response = await fetch("https://agile-retreat-56464.herokuapp.com/api/account/create", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
