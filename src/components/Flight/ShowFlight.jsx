...
class ShowFlight extends React.Component {
  ...
  async componentDidMount() {
    ...
    const response_user_data = await fetch(`https://agile-retreat-56464.herokuapp.com/get_user_data/${customerID}`, {
      method: "POST",
      headers: {
    ...
    const response = await fetch(`https://agile-retreat-56464.herokuapp.com/api/get_flight/${idFlightParam}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  handleBookFlight = async (e) => {
    ...
    const response = await fetch("https://agile-retreat-56464.herokuapp.com/api/book_flight", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  cancelFlightBooking = async (e) => {
    ...
    const response = await fetch(`https://agile-retreat-56464.herokuapp.com/api/cancel_booking/${flightID}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
